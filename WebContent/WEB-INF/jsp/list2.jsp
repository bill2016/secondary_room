...
<body>
	...
	<div class="select">
		<label>区域： </label><a href="#" onClick="submits('district','','')"
			class="bx">不限</a>&nbsp <a href="#">保安</a>&nbsp <a href='#'
			onClick="submits('district','天河','')">龙岗</a>&nbsp <a href="#">南山</a>&nbsp<a
			href="#">福田</a>&nbsp<a href="#">罗湖</a>&nbsp<a href='#'
			onClick="submits('district','番禺','')">盐田</a><br /> <br /> <label>总价：
